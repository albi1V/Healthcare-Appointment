...
//      * Example: findBySpecialtyAndAvailability("Cardiologist", "Yes")
//      */
//     List<Doctor> findBySpecialtyAndAvailability(String specialty, String availability);
 
//     /**
//      * Find all doctors by specialty (regardless of availability)
...
public interface DoctorRepository extends JpaRepository<Doctor, Long> {
    ...
    List<Doctor> findBySpecialtyIgnoreCaseAndAvailabilityIsNotNullAndAvailabilityNot(
